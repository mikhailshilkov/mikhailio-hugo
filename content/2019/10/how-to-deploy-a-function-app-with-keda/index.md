...
date: 2019-10-10
thumbnail: meta.png
tags: ["Azure", "Azure Functions", "Kubernetes", "Serverless", "Pulumi"]
description: "Hosting Azure Functions in Kubernetes: how it works and the simplest way to get started."
ghissueid: 23
originalSource: Pulumi Blog
originalUrl: https://www.pulumi.com/blog/deploy-a-function-app-with-keda/
---
...
{{< figure src="idea.png" title="Components of an automatically scaled application" >}}
...
{{< figure src="functionapp.png" title="Azure Functions Consumption Plan" >}}
...
The cloud provider manages all the components of the system, so developers can focus on writing business logic code. It can be [as simple as a JavaScript callback]({{< relref "2019/08/ten-pearls-with-azure-functions-in-pulumi" >}}):
...
{{< figure src="keda.png" title="Kubernetes-based Event-Driven Autoscaling" >}}
