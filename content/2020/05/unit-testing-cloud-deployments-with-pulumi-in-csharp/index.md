---
title: "Unit Testing Cloud Deployments with Pulumi in C#"
date: 2020-05-21
thumbnail: dotnet-testing.png
tags: ["Pulumi", "Unit Testing", "TDD", "CSharp"]
description: "Developing infrastructure programs in C# with unit tests, TDD, and mocks"
ghissueid: 38
...
This blog post takes a deeper dive into mock-based unit testing of Pulumi programs written in C#. You can find an F# version of this blog post [here](/2020/05/unit-testing-cloud-deployments-with-pulumi-in-fsharp/).
...
[Pulumi testing guide](https://www.pulumi.com/docs/guides/testing/) outlines several testing methods, but today I want to focus on unit testing.
...
Here is my starting point in `WebsiteStack.cs` file:
...
- [Full code for this blog post](https://github.com/pulumi/examples/tree/72c9480f4c1240f795f6020f50801733fbef37f2/testing-unit-cs-mocks).
