...
date: 2020-09-21
thumbnail: azure-nextgen.png
tags: ["Pulumi", "Azure"]
description: "Next Generation Pulumi Azure Provider with 100% API Coverage and Same-Day Feature Support is now available in beta"
ghissueid: 44
originalSource: Pulumi Blog
originalUrl: https://www.pulumi.com/blog/announcing-nextgen-azure-provider/
---
...
API documentation is available at [Azure NextGen API Reference](https://pulumi.com/docs/reference/pkg/azure-nextgen) and includes more than 1,000 resource examples.
