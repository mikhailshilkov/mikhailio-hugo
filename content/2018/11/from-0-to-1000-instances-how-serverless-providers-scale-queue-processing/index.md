...
{{< figure src="aws-lambda-queue-scaling.png" title="Model of AWS Lambda Scale-Out" >}}
...
{{< figure src="azure-function-queue-scaling.png" title="Model of Azure Function Scale-Out" >}}
...
{{< featured >}}
{{< figure src="aws-lambda-sqs-iobound-scaling.png" title="AWS Lambda processing 100k SQS messages with \"Pause\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="gcp-cloud-function-pubsub-iobound-scaling.png" title="Google Cloud Function processing 100k Pub/Sub messages with \"Pause\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="azure-function-queue-iobound-scaling.png" title="Azure Function processing 100k queue messages with \"Pause\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="aws-lambda-sqs-cpubound-scaling.png" title="AWS Lambda (128 MB) processing 100k SQS messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="aws-lambda-sqs-cpubound-scaling-512.png" title="AWS Lambda (512 MB) processing 100k SQS messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="gcp-cloud-function-pubsub-cpubound-scaling.png" title="Google Cloud Function (128 MB) processing 100k Pub/Sub messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="gcp-cloud-function-pubsub-cpubound-scaling-512.png" title="Google Cloud Function (512 MB) processing 100k Pub/Sub messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="gcp-cloud-function-pubsub-cpubound-scaling-2048.png" title="Google Cloud Function (2 GB) processing 100k Pub/Sub messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
...
{{< featured >}}
{{< figure src="azure-function-queue-cpubound-scaling.png" title="Azure Function processing 100k queue messages with \"Bcrypt\" handler" >}}
{{< /featured >}}
