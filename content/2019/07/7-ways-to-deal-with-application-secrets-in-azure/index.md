...
tags: ["Pulumi", "Azure", "Security"]
description: From config files to Key Vault and role-based access, learn how infrastructure as code helps manage application secrets in Azure.
originalSource: Pulumi Blog
originalUrl: https://www.pulumi.com/blog/7-ways-to-deal-with-application-secrets-in-azure/
ghissueid: 16
---
