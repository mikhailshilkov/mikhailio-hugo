...
description: "AWS recently announced the launch of Provisioned Concurrency, a new feature of AWS Lambda that intends to solve the problem of cold starts."
ghissueid: 27
originalSource: Pulumi Blog
originalUrl: https://www.pulumi.com/blog/aws-lambda-provisioned-concurrency-no-cold-starts/
---
...
{{< figure src="executions.png" title="Overlapping executions land on separate workers" >}}
...
{{< figure src="steady.png" title="Fixed provisioned concurrency for uniform workloads" >}}
...
{{< figure src="scheduled.png" title="Provisioned concurrency matches predictable workload changes" >}}
...
{{< figure src="variable.png" title="Provisioned concurrency matches the variation in workload" >}}
...
{{< figure src="pricing.png" title="Comparison of the cost of a 1GB worker for two billing models" >}}
